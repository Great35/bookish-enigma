...
jQuery(window).on("load", function() {
    var e = parseFloat(getScrollBarWidth());
    jQuery(".fusion-modal").each(function() {
        jQuery(this).parent(".fusion-builder-element-content").length || jQuery("body").append(jQuery(this))
    }), jQuery(".fusion-modal").bind("hidden.bs.modal", function() {
        jQuery("html").css("overflow", ""), 0 !== e && (jQuery("body").hasClass("layout-boxed-mode") && jQuery('#sliders-container .main-flex[data-parallax="1"]').css("margin-left", function(n, i) {
            return parseFloat(i) + e / 2 + "px"
        ...
        var n, i = 'body, .fusion-is-sticky .fusion-header, .fusion-is-sticky .fusion-secondary-main-menu, #sliders-container .main-flex[data-parallax="1"], #wpadminbar, .fusion-footer.fusion-footer-parallax';
        jQuery("html").css("overflow", "visible"), 0 !== e && (jQuery("body").hasClass("layout-boxed-mode") && (i = "body, #wpadminbar", jQuery('#sliders-container .main-flex[data-parallax="1"]').css("margin-left", function(n, i) {
            return parseFloat(i) - e / 2 + "px"
        })), jQuery(i).css("padding-right", function(n, i) {
            return parseFloat(i) + e + "px"
        })), n = jQuery(this), setTimeout(function() {
            jQuery(window).trigger("fusion-dynamic-content-render", n), jQuery(window).trigger("resize", ["modal-open"]), "function" == typeof fusionOnloadCallback && fusionOnloadCallback()
        }, 350)
