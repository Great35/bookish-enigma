...
! function(e, t) {
    ...
    const p = {
        ...
        on: function() {
            ...
            function l(e) {
                ...
                if (0 > s.indexOf(e) && s.unshift(e), d(t).is(a)) n.apply(t, s);
                else {
                    const e = d(t).parents();
                    for (let t = 0; t < e.length; t += 1) d(e[t]).is(a) && n.apply(e[t], s)
                }
            }
            ...
            "function" == typeof t[1] && ([i, n, r] = t, a = void 0), r || (r = !1);
            const p = i.split(" ");
            let c;
        ...
        off: function() {
            ...
            for (let e = 0; e < l.length; e += 1) {
                ...
                for (let e = 0; e < this.length; e += 1) {
                    const s = this[e];
                    let i;
                    if (!a && s.dom7Listeners ? i = s.dom7Listeners[t] : a && s.dom7LiveListeners && (i = s.dom7LiveListeners[t]), i && i.length)
                        for (let e = i.length - 1; 0 <= e; e -= 1) {
                            const a = i[e];
                            n && a.listener === n ? (s.removeEventListener(t, a.proxyListener, r), i.splice(e, 1)) : n && a.listener && a.listener.dom7proxy && a.listener.dom7proxy === n ? (s.removeEventListener(t, a.proxyListener, r), i.splice(e, 1)) : n || (s.removeEventListener(t, a.proxyListener, r), i.splice(e, 1))
                        }
                }
            }
            return this
            ...
            for (let t = 0; t < a.length; t += 1) {
                ...
                for (let t = 0; t < this.length; t += 1) {
                    ...
                    if (e.CustomEvent) {
                        ...
                        a.dom7EventData = s.filter((e, t) => 0 < t), a.dispatchEvent(t), a.dom7EventData = [], delete a.dom7EventData
                    }
                }
            }
            return this
        ...
        prepend: function(e) {
            ...
            for (s = 0; s < this.length; s += 1)
                if ("string" == typeof e) {
                    const i = t.createElement("div");
                    for (i.innerHTML = e, a = i.childNodes.length - 1; 0 <= a; a -= 1) this[s].insertBefore(i.childNodes[a], this[s].childNodes[0])
                } else if (e instanceof r)
    ...
    function h(e, t) {
        ...
        return s.WebKitCSSMatrix ? (6 < (a = l.transform || l.webkitTransform).split(",").length && (a = a.split(", ").map(e => e.replace(",", ".")).join(", ")), r = new s.WebKitCSSMatrix("none" === a ? "" : a)) : i = (r = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform || l.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (a = s.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (a = s.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), a || 0
    }
    ...
    function m() {
        ...
        for (let i = 1; i < arguments.length; i += 1) {
            ...
            if (void 0 !== a && null !== a && (s = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                const s = Object.keys(Object(a)).filter(e => 0 > t.indexOf(e));
                for (let t = 0, i = s.length; t < i; t += 1) {
                    const i = s[t],
                        n = Object.getOwnPropertyDescriptor(a, i);
                    void 0 !== n && n.enumerable && (f(e[i]) && f(a[i]) ? a[i].__swiper__ ? e[i] = a[i] : m(e[i], a[i]) : !f(e[i]) && f(a[i]) ? (e[i] = {}, a[i].__swiper__ ? e[i] = a[i] : m(e[i], a[i])) : e[i] = a[i])
                }
            }
        }
        var s;
    ...
    function T(e) {
        return void 0 === e && (e = {}), b || (b = function(e) {
            const {
                userAgent: t
            } = void 0 === e ? {} : e, s = C(), i = n(), a = i.navigator.platform, r = t || i.navigator.userAgent, l = {
                ios: !1,
                android: !1
            }, o = i.screen.width, d = i.screen.height, p = r.match(/(Android);?[\s\/]+([\d.]+)?/);
            let c = r.match(/(iPad).*OS\s([\d_]+)/);
            const u = r.match(/(iPod)(.*OS\s([\d_]+))?/),
                h = !c && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                f = "Win32" === a;
            let m = "MacIntel" === a;
            return !c && m && s.touch && 0 <= ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${d}`) && ((c = r.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]), m = !1), p && !f && (l.os = "android", l.android = !0), (c || h || u) && (l.os = "ios", l.ios = !0), l
        }(e)), b
    }
    ...
    var E = {
        ...
        onAny(e, t) {
            ...
            return 0 > s.eventsAnyListeners.indexOf(e) && s.eventsAnyListeners[i](e), s
        },
        offAny(e) {
            const t = this;
            ...
            return 0 <= s && t.eventsAnyListeners.splice(s, 1), t
        },
        off(e, t) {
            const s = this;
    ...
    function $(e) {
        ...
        if (!r.isTouchEvent && "button" in c && 0 < c.button) return;
        ...
        if (Object.assign(r, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), o.startX = w, o.startY = b, r.touchStartTime = u(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, 0 < l.threshold && (r.allowThresholdMove = !1), "touchstart" !== c.type) {
            let e = !0;
    ...
    const L = (e, t) => {
        ...
        if (d.touch) {
            ...
            r[c](n.start, e.onTouchStart, t), r[c](n.move, e.onTouchMove, d.passiveListener ? {
                passive: !1,
                capture: p
            } : p), r[c](n.end, e.onTouchEnd, t), n.cancel && r[c](n.cancel, e.onTouchEnd, t)
        } else r[c](n.start, e.onTouchStart, !1), s[c](n.move, e.onTouchMove, p), s[c](n.end, e.onTouchEnd, !1);
        (a.preventClicks || a.preventClicksPropagation) && r[c]("click", e.onClick, !0), a.cssMode && l[c]("scroll", e.onScroll), a.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", M, !0) : e[u]("observerUpdate", M, !0)
    };
    ...
    const I = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    let y = i.spaceBetween,
                        ...
                        x = 0;
                    if (void 0 === n) return;
                    "string" == typeof y && 0 <= y.indexOf("%") && (y = parseFloat(y.replace("%", "")) / 100 * n), e.virtualSize = -y, r ? p.css({
                        marginLeft: "",
                        marginBottom: "",
                        marginTop: ""
                    }) : p.css({
                    ...
                    for (let a = 0; a < c; a += 1) {
                        S = 0;
                        const r = p.eq(a);
                        if (E && e.grid.updateSlide(a, r, c, t), "none" !== r.css("display")) {
                            if ("auto" === i.slidesPerView) {
                                $ && (p[a].style[t("width")] = "");
                                const n = getComputedStyle(r[0]),
                                    l = r[0].style.transform,
                                    o = r[0].style.webkitTransform;
                                if (l && (r[0].style.transform = "none"), o && (r[0].style.webkitTransform = "none"), i.roundLengths) S = e.isHorizontal() ? r.outerWidth(!0) : r.outerHeight(!0);
                                else {
                                    const e = s(n, "width"),
                                        t = s(n, "padding-left"),
                                        i = s(n, "padding-right"),
                                ...
                                l && (r[0].style.transform = l), o && (r[0].style.webkitTransform = o), i.roundLengths && (S = Math.floor(S))
                            } else S = (n - (i.slidesPerView - 1) * y) / i.slidesPerView, i.roundLengths && (S = Math.floor(S)), p[a] && (p[a].style[t("width")] = `${S}px`);
                            p[a] && (p[a].swiperSlideSize = S), f.push(S), i.centeredSlides ? (C = C + S / 2 + T / 2 + y, 0 === T && 0 !== a && (C = C - n / 2 - y), 0 === a && (C = C - n / 2 - y), Math.abs(C) < .001 && (C = 0), i.roundLengths && (C = Math.floor(C)), 0 == x % i.slidesPerGroup && u.push(C), h.push(C)) : (i.roundLengths && (C = Math.floor(C)), 0 == (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup && u.push(C), h.push(C), C = C + S + y), e.virtualSize += S + y, T = S, x += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, n) + v, r && l && ("slide" === i.effect || "coverflow" === i.effect) && a.css({
                            width: `${e.virtualSize+i.spaceBetween}px`
                        }), i.setWrapperSize && a.css({
                            [t("width")]: `${e.virtualSize+i.spaceBetween}px`
                        }), E && e.grid.updateWrapperSize(S, u, t), !i.centeredSlides) {
                        const t = [];
                    ...
                    if (c !== d && e.emit("slidesLengthChange"), u.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== b && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(o || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
                ...
                updateSlidesProgress: function(e) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        (0 <= c && c < t.size - 1 || 1 < u && u <= t.size || 0 >= c && u >= t.size) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)), l.progress = a ? -d : d, l.originalProgress = a ? -p : p
                    }
                ...
                updateProgress: function(e) {
                    ...
                    const l = n,
                        o = r;
                    0 === i ? (a = 0, n = !0, r = !0) : (n = 0 >= (a = (e - t.minTranslate()) / i), r = 1 <= a), Object.assign(t, {
                        progress: a,
                        isBeginning: n,
                        isEnd: r
                    }), (s.watchSlidesProgress || s.centeredSlides && s.autoHeight) && t.updateSlidesProgress(e), n && !l && t.emit("reachBeginning toEdge"), r && !o && t.emit("reachEnd toEdge"), (l && !n || o && !r) && t.emit("fromEdge"), t.emit("progress", a)
                },
            ...
            translate: {
                ...
                setTranslate: function(e, t) {
                    ...
                    let o, d = 0,
                        p = 0;
                    s.isHorizontal() ? d = i ? -e : e : p = e, a.roundLengths && (d = Math.floor(d), p = Math.floor(p)), a.cssMode ? r[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -d : -p : a.virtualTranslate || n.transform(`translate3d(${d}px, ${p}px, 0px)`), s.previousTranslate = s.translate, s.translate = s.isHorizontal() ? d : p;
            ...
            transition: {
                ...
                transitionStart: function(e, t) {
                    ...
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), S({
                        swiper: s,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                ...
                transitionEnd: function(e, t) {
                    ...
                    this.animating = !1, s.cssMode || (this.setTransition(0), S({
                        swiper: this,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
            ...
            slide: {
                slideTo: function(e, t, s, i, a) {
                    ...
                    if (n.initialized && r !== c) {
                        ...
                        if (!n.allowSlidePrev && w > n.translate && w > n.maxTranslate() && (c || 0) !== r) return !1
                    }
                    let b;
                    if (r !== (p || 0) && s && n.emit("beforeSlideChangeStart"), n.updateProgress(w), b = r > c ? "next" : r < c ? "prev" : "reset", u && -w === n.translate || !u && w === n.translate) return n.updateActiveIndex(r), l.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== l.effect && n.setTranslate(w), "reset" !== b && (n.transitionStart(s, b), n.transitionEnd(s, b)), !1;
                    if (l.cssMode) {
                        const e = n.isHorizontal(),
                            s = u ? w : -w;
                        if (0 === t) {
                    ...
                    return n.setTransition(t), n.setTranslate(w), n.updateActiveIndex(r), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(s, b), 0 === t ? n.transitionEnd(s, b) : n.animating || (n.animating = !0, n.onSlideToWrapperTransitionEnd || (n.onSlideToWrapperTransitionEnd = function(e) {
                ...
                slidePrev: function(e, t, s) {
                    ...
                    let h = 0;
                    if (void 0 !== u && (0 > (h = l.indexOf(u)) && (h = i.activeIndex - 1), "auto" === a.slidesPerView && 1 === a.slidesPerGroup && a.slidesPerGroupAuto && (h = h - i.slidesPerViewDynamic("previous", !0) + 1, h = Math.max(h, 0))), a.rewind && i.isBeginning) {
                ...
                slideToClickedSlide: function() {
                    ...
                    if (t.loop) {
                        ...
                        a = parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = s.children(`.${t.slideClass}[data-swiper-slide-index="${a}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), c(() => {
                            e.slideTo(n)
                        })) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = s.children(`.${t.slideClass}[data-swiper-slide-index="${a}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), c(() => {
                            e.slideTo(n)
                        })) : e.slideTo(n)
                    } else e.slideTo(n)
                }
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = $.bind(e), e.onTouchMove = function(e) {
                        const t = i(),
                            s = this,
                            a = s.touchEventsData,
                            {
                        ...
                        if (!s.allowTouchMove) return d(p.target).is(a.focusableElements) || (s.allowClick = !1), void(a.isTouched && (Object.assign(r, {
                            startX: h,
                            startY: f,
                            currentX: h,
                            currentY: f
                        ...
                        if (a.isTouchEvent && t.activeElement && p.target === t.activeElement && d(p.target).is(a.focusableElements)) return a.isMoved = !0, void(s.allowClick = !1);
                        if (a.allowTouchCallbacks && s.emit("touchMove", p), p.targetTouches && 1 < p.targetTouches.length) return;
                        ...
                        if (t.allowClick) {
                            ...
                            t.updateClickedSlide(e && e[0] || o.target), t.emit("tap click", o), 300 > p && 300 > d - s.lastClickTime && t.emit("doubleTap doubleClick", o)
                        }
                        ...
                        if (p > i.longSwipesMs) {
                            ...
                            "next" === t.swipeDirection && (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? g : f + b) : t.slideTo(f)), "prev" === t.swipeDirection && (w > 1 - i.longSwipesRatio ? t.slideTo(f + b) : null !== v && 0 > w && Math.abs(w) > i.longSwipesRatio ? t.slideTo(v) : t.slideTo(f))
                        } else {
                        ...
                        (a = 0 === n ? 0 : (e.translate - e.minTranslate()) / n) !== e.progress && e.updateProgress(s ? -e.translate : e.translate), e.emit("setTranslate", e.translate, !1)
                    }.bind(e)), e.onClick = function(e) {
                        const t = this;
                        t.enabled && (t.allowClick || (t.params.preventClicks && e.preventDefault(), t.params.preventClicksPropagation && t.animating && (e.stopPropagation(), e.stopImmediatePropagation())))
                    }.bind(e), a.touch && !k && (t.addEventListener("touchstart", P), k = !0), L(e, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const o = (l in r ? r[l] : void 0) || e.originalParams,
                        ...
                        p = O(e, o),
                        c = a.enabled;
                    d && !p ? (n.removeClass(`${a.containerModifierClass}grid ${a.containerModifierClass}grid-column`), e.emitContainerClasses()) : !d && p && (n.addClass(`${a.containerModifierClass}grid`), (o.grid.fill && "column" === o.grid.fill || !o.grid.fill && "column" === a.grid.fill) && n.addClass(`${a.containerModifierClass}grid-column`), e.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach(t => {
                    ...
                    }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", o), h && s && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - i + e.loopedSlides, 0, !1)), e.emit("breakpoint", o)
                },
            ...
            images: {
                loadImage: function(e, t, s, i, a, r) {
                    ...
                    d(e).parent("picture")[0] || e.complete && a ? p() : t ? ((o = new l.Image).onload = p, o.onerror = p, i && (o.sizes = i), s && (o.srcset = s), t && (o.src = t)) : p()
                },
    ...
    class D {
        constructor() {
            ...
            if (1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = m({}, t), e && !t.el && (t.el = e), t.el && 1 < d(t.el).length) {
                const e = [];
            ...
            const n = this;
            n.__swiper__ = !0, n.support = C(), n.device = T({
                userAgent: t.userAgent
            }), n.browser = x(), n.eventsListeners = {}, n.eventsAnyListeners = [], n.modules = [...n.__modules__], t.modules && Array.isArray(t.modules) && n.modules.push(...t.modules);
            const r = {};
            n.modules.forEach(e => {
                e({
                    swiper: n,
            ...
            const l = m({}, z, r);
            return n.params = m({}, l, A, t), n.originalParams = m({}, n.params), n.passedParams = m({}, t), n.params && n.params.on && Object.keys(n.params.on).forEach(e => {
        ...
        slidesPerViewDynamic(e, t) {
            ...
            if (s.centeredSlides) {
                ...
                for (let s = l + 1; s < i.length; s += 1) i[s] && !e && (o += 1, (t += i[s].swiperSlideSize) > r && (e = !0));
                for (let s = l - 1; 0 <= s; s -= 1) i[s] && !e && (o += 1, (t += i[s].swiperSlideSize) > r && (e = !0))
            } else if ("current" === e)
        ...
        changeDirection(e, t) {
            ...
            return e || (e = "horizontal" === i ? "vertical" : "horizontal"), e === i || "horizontal" !== e && "vertical" !== e ? s : (s.$el.removeClass(`${s.params.containerModifierClass}${i}`).addClass(`${s.params.containerModifierClass}${e}`), s.emitContainerClasses(), s.params.direction = e, s.slides.each(t => {
    ...
    function N(e, t, s, a) {
        ...
        return e.params.createElements && Object.keys(a).forEach(i => {
            if (!s[i] && !0 === s.auto) {
                ...
                r || ((r = n.createElement("div")).className = a[i], e.$el.append(r)), s[i] = r, t[i] = r
            }
        }), s
    }
    ...
    Object.keys(I).forEach(e => {
        ...
        s("init", () => {
            ...
            l && a.cancelAnimationFrame(l), r && r.unobserve && t.el && (r.unobserve(t.el), r = null), a.removeEventListener("resize", o), a.removeEventListener("orientationchange", d)
        })
    }, function(e) {
        const {
            swiper: t,
    ...
    const j = [function(e) {
        ...
        function p(e) {
            ...
            const a = i.keyCode || i.charCode,
                ...
                h = 38 === a,
                f = 40 === a;
            if (!t.allowSlideNext && (t.isHorizontal() && u || t.isVertical() && f || p)) return !1;
            if (!t.allowSlidePrev && (t.isHorizontal() && c || t.isVertical() && h || d)) return !1;
            if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
                ...
                t.isHorizontal() ? ((d || p || c || u) && (i.preventDefault ? i.preventDefault() : i.returnValue = !1), ((p || u) && !s || (d || c) && s) && t.slideNext(), ((d || c) && !s || (p || u) && s) && t.slidePrev()) : ((d || p || h || f) && (i.preventDefault ? i.preventDefault() : i.returnValue = !1), (p || f) && t.slideNext(), (d || h) && t.slidePrev()), r("keyPress", a)
            }
        }

        function c() {
            t.keyboard.enabled || (d(l).on("keydown", p), t.keyboard.enabled = !0)
        }

        function u() {
            t.keyboard.enabled && (d(l).off("keydown", p), t.keyboard.enabled = !1)
        }
        t.keyboard = {
            enabled: !1
        }, s({
        ...
        function g(e) {
            return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta || t.params.mousewheel.thresholdTime && u() - p < t.params.mousewheel.thresholdTime || !(6 <= e.delta && 60 > u() - p) && (0 > e.direction ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(), a("scroll", e.raw)) : t.isBeginning && !t.params.loop || t.animating || (t.slidePrev(), a("scroll", e.raw)), p = (new r.Date).getTime(), 1))
        }
        ...
        function v(e) {
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), (i = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate())) && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                const e = {
                        time: u(),
                        delta: Math.abs(p),
                ...
                if (!i) {
                    ...
                    if (r >= t.minTranslate() && (r = t.minTranslate()), r <= t.maxTranslate() && (r = t.maxTranslate()), t.setTransition(0), t.setTranslate(r), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!d && t.isBeginning || !u && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
                        clearTimeout(l), l = void 0, 15 <= h.length && h.shift();
                    ...
                    if (i || a("scroll", s), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), r === t.minTranslate() || r === t.maxTranslate()) return !0
                }
            } else {
                const s = {
                    time: u(),
        ...
        function n(e) {
            let s;
            return e && (s = d(e), t.params.uniqueNavElements && "string" == typeof e && 1 < s.length && 1 === t.$el.find(e).length && (s = t.$el.find(e))), s
        }

        function r(e, s) {
            const i = t.params.navigation;
            e && 0 < e.length && (e[s ? "addClass" : "removeClass"](i.disabledClass), e[0] && "BUTTON" === e[0].tagName && (e[0].disabled = s), t.params.watchOverflow && t.enabled && e[t.isLocked ? "addClass" : "removeClass"](i.lockClass))
        }
        ...
        function c() {
            ...
            const s = n(e.nextEl),
                i = n(e.prevEl);
            s && 0 < s.length && s.on("click", p), i && 0 < i.length && i.on("click", o), Object.assign(t.navigation, {
                $nextEl: s,
                nextEl: s && s[0],
                $prevEl: i,
                prevEl: i && i[0]
        ...
        s({
            ...
            if (t.params.navigation.hideOnClick && !d(r).is(n) && !d(r).is(i)) {
                ...
                let e;
                i ? e = i.hasClass(t.params.navigation.hiddenClass) : n && (e = n.hasClass(t.params.navigation.hiddenClass)), a(!0 === e ? "navigationShow" : "navigationHide"), i && i.toggleClass(t.params.navigation.hiddenClass), n && n.toggleClass(t.params.navigation.hiddenClass)
            }
        });
        const h = () => {
        ...
        function c() {
            ...
            if (t.params.loop ? ((c = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > i - 1 - 2 * t.loopedSlides && (c -= i - 2 * t.loopedSlides), c > u - 1 && (c -= u), 0 > c && "bullets" !== t.params.paginationType && (c = u + c)) : c = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && 0 < t.pagination.bullets.length) {
                const i = t.pagination.bullets;
                let a, o, u;
                if (s.dynamicBullets && (r = i.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), n.css(t.isHorizontal() ? "width" : "height", `${r*(s.dynamicMainBullets+4)}px`), 1 < s.dynamicMainBullets && void 0 !== t.previousIndex && ((l += c - (t.previousIndex - t.loopedSlides || 0)) > s.dynamicMainBullets - 1 ? l = s.dynamicMainBullets - 1 : 0 > l && (l = 0)), a = Math.max(c - l, 0), u = ((o = a + (Math.min(i.length, s.dynamicMainBullets) - 1)) + a) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => `${s.bulletActiveClass}${e}`).join(" ")), 1 < n.length) i.each(e => {
                    const t = d(e),
                        i = t.index();
                    i === c && t.addClass(s.bulletActiveClass), s.dynamicBullets && (i >= a && i <= o && t.addClass(`${s.bulletActiveClass}-main`), i === a && p(t, "prev"), i === o && p(t, "next"))
                });
                else {
                    const e = i.eq(c),
                        n = e.index();
                    if (e.addClass(s.bulletActiveClass), s.dynamicBullets) {
                        ...
                        if (t.params.loop)
                            if (n >= i.length) {
                                for (let e = s.dynamicMainBullets; 0 <= e; e -= 1) i.eq(i.length - e).addClass(`${s.bulletActiveClass}-main`);
                                i.eq(i.length - s.dynamicMainBullets - 1).addClass(`${s.bulletActiveClass}-prev`)
                            } else p(e, "prev"), p(r, "next");
                        else p(e, "prev"), p(r, "next")
                    }
                }
                if (s.dynamicBullets) {
            ...
            if ("fraction" === s.type && (n.find(B(s.currentClass)).text(s.formatFractionCurrent(c + 1)), n.find(B(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                let e;
                e = s.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                const i = (c + 1) / u;
                let a = 1,
                    r = 1;
                "horizontal" === e ? a = i : r = i, n.find(B(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${a}) scaleY(${r})`).transition(t.params.speed)
            }
            "custom" === s.type && s.renderCustom ? (n.html(s.renderCustom(t, c + 1, u)), a("paginationRender", n[0])) : a("paginationUpdate", n[0]), t.params.watchOverflow && t.enabled && n[t.isLocked ? "addClass" : "removeClass"](s.lockClass)
        }
        ...
        function u() {
            ...
            if ("bullets" === e.type) {
                ...
                for (let s = 0; s < a; s += 1) e.renderBullet ? n += e.renderBullet.call(t, s, e.bulletClass) : n += `<${e.bulletElement} class="${e.bulletClass}"></${e.bulletElement}>`;
                i.html(n), t.pagination.bullets = i.find(B(e.bulletClass))
            }
            "fraction" === e.type && (n = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span>` + " / " + `<span class="${e.totalClass}"></span>`, i.html(n)), "progressbar" === e.type && (n = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`, i.html(n)), "custom" !== e.type && a("paginationRender", t.pagination.$el[0])
        }
        ...
        function f() {
            ...
            s.removeClass(e.hiddenClass), s.removeClass(e.modifierClass + e.type), s.removeClass(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && s.off("click", B(e.bulletClass))
        }
        i("init", () => {
        ...
        Object.assign(t.pagination, {
            enable: () => {
                t.$el.removeClass(t.params.pagination.paginationDisabledClass), t.pagination.$el && t.pagination.$el.removeClass(t.params.pagination.paginationDisabledClass), h(), u(), c()
            },
            disable: m,
            render: u,
            update: c,
        ...
        function o(e, s) {
            ...
            !n.hasClass(i.elementClass) || n.hasClass(i.loadedClass) || n.hasClass(i.loadingClass) || r.push(n[0]), 0 !== r.length && r.each(e => {
                const r = d(e);
                ...
                t.loadImage(r[0], p || l, c, u, !1, () => {
                    if (void 0 !== t && null !== t && t && (!t || t.params) && !t.destroyed) {
                        if (l ? (r.css("background-image", `url("${l}")`), r.removeAttr("data-background")) : (c && (r.attr("srcset", c), r.removeAttr("data-srcset")), u && (r.attr("sizes", u), r.removeAttr("data-sizes")), h.length && h.children("source").each(e => {
                                const t = d(e);
                                t.attr("data-srcset") && (t.attr("srcset", t.attr("data-srcset")), t.removeAttr("data-srcset"))
                            }), p && (r.attr("src", p), r.removeAttr("data-src"))), r.addClass(i.loadedClass).removeClass(i.loadingClass), n.find(`.${i.preloaderClass}`).remove(), t.params.loop && s) {
        ...
        function p() {
            ...
            if ("auto" === p && (p = 0), l || (l = !0), t.params.watchSlidesProgress) e.children(`.${s.slideVisibleClass}`).each(e => {
                o(n ? d(e).attr("data-swiper-slide-index") : d(e).index())
            });
            else if (1 < p)
                for (let e = a; e < a + p; e += 1) c(e) && o(e);
            else o(a);
            if (r.loadPrevNext)
                if (1 < p || r.loadPrevNextAmount && 1 < r.loadPrevNextAmount) {
                    ...
                    for (let e = a + t; e < s; e += 1) c(e) && o(e);
                    for (let e = n; e < a; e += 1) c(e) && o(e)
                } else {
        ...
        function c() {
            ...
            h ? (p(), s.off("scroll", c, m)) : r || (r = !0, s.on("scroll", c, m))
        }
        i("beforeInit", () => {
        ...
        const v = (e, t, s) => {
            r(e), "BUTTON" !== e[0].tagName && (o(e, "button"), e.on("keydown", f)), c(e, s), w = t, e.attr("aria-controls", w)
        };
        var w;
        const b = () => {
                t.a11y.clicked = !0
            ...
            C = e => {
                ...
                i || a || (t.isHorizontal() ? t.el.scrollLeft = 0 : t.el.scrollTop = 0, t.slideTo(t.slides.indexOf(s), 0))
            },
            T = () => {
            ...
            x = () => {
                ...
                const i = t.$wrapperEl,
                    n = e.id || i.attr("id") || `swiper-wrapper-${E=16,void 0===E&&(E=16),"x".repeat(E).replace(/x/g,()=>Math.round(16*Math.random()).toString(16))}`,
        ...
        i("beforeInit", () => {
            ...
            t.params.a11y.enabled && function() {
                ...
                s && 0 < s.length && (t.isBeginning ? (u(s), l(s)) : (h(s), r(s))), e && 0 < e.length && (t.isEnd ? (u(e), l(e)) : (h(e), r(e)))
            }()
        }), i("paginationUpdate", () => {
            t.params.a11y.enabled && function() {
                const e = t.params.a11y;
                m() && t.pagination.bullets.each(s => {
                    const i = d(s);
                    t.params.pagination.clickable && (r(i), t.params.pagination.renderBullet || (o(i, "button"), c(i, e.paginationBulletMessage.replace(/\{\{index\}\}/, i.index() + 1)))), i.is(`.${t.params.pagination.bulletActiveClass}`) ? i.attr("aria-current", "true") : i.removeAttr("aria-current")
                })
            }()
        }), i("destroy", () => {
            t.params.a11y.enabled && function() {
                let e, s;
                a && 0 < a.length && a.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (s = t.navigation.$prevEl), e && e.off("keydown", f), s && s.off("keydown", f), g() && t.pagination.$el.off("keydown", B(t.params.pagination.bulletClass), f), t.$el.off("focus", C, !0), t.$el.off("pointerdown", b, !0), t.$el.off("pointerup", y, !0)
            }()
        })
    }, function(e) {
        const {
        ...
        function l() {
            ...
            e.attr("data-swiper-autoplay") && (s = e.attr("data-swiper-autoplay") || t.params.autoplay.delay), clearTimeout(r), r = c(() => {
                let e;
                t.params.autoplay.reverseDirection ? t.params.loop ? (t.loopFix(), e = t.slidePrev(t.params.speed, !0, !0), n("autoplay")) : t.isBeginning ? t.params.autoplay.stopOnLastSlide ? d() : (e = t.slideTo(t.slides.length - 1, t.params.speed, !0, !0), n("autoplay")) : (e = t.slidePrev(t.params.speed, !0, !0), n("autoplay")) : t.params.loop ? (t.loopFix(), e = t.slideNext(t.params.speed, !0, !0), n("autoplay")) : t.isEnd ? t.params.autoplay.stopOnLastSlide ? d() : (e = t.slideTo(0, t.params.speed, !0, !0), n("autoplay")) : (e = t.slideNext(t.params.speed, !0, !0), n("autoplay")), t.params.cssMode && t.autoplay.running ? l() : !1 === e && l()
            }, s)
        }

        function o() {
            return void 0 === r && !t.autoplay.running && (t.autoplay.running = !0, n("autoplayStart"), l(), !0)
        }

        function d() {
            return !!t.autoplay.running && void 0 !== r && (r && (clearTimeout(r), r = void 0), t.autoplay.running = !1, n("autoplayStop"), !0)
        }

        function p(e) {
            t.autoplay.running && (t.autoplay.paused || (r && clearTimeout(r), t.autoplay.paused = !0, 0 !== e && t.params.autoplay.waitForTransition ? ["transitionend", "webkitTransitionEnd"].forEach(e => {
                t.$wrapperEl[0].addEventListener(e, h)
            }) : (t.autoplay.paused = !1, l())))
        }

        function u() {
            const e = i();
            "hidden" === e.visibilityState && t.autoplay.running && p(), "visible" === e.visibilityState && t.autoplay.paused && (l(), t.autoplay.paused = !1)
        }
        ...
        function h(e) {
            ...
            }), t.autoplay.paused = !1, t.autoplay.running ? l() : d())
        }

        function f() {
            t.params.autoplay.disableOnInteraction ? d() : (n("autoplayPause"), p()), ["transitionend", "webkitTransitionEnd"].forEach(e => {
                t.$wrapperEl[0].removeEventListener(e, h)
            })
        }

        function m() {
            t.params.autoplay.disableOnInteraction || (t.autoplay.paused = !1, n("autoplayResume"), l())
        }
        t.autoplay = {
            running: !1,
            paused: !1
            ...
            t.params.autoplay.enabled && (o(), i().addEventListener("visibilitychange", u), t.params.autoplay.pauseOnMouseEnter && (t.$el.on("mouseenter", f), t.$el.on("mouseleave", m)))
            ...
            t.$el.off("mouseenter", f), t.$el.off("mouseleave", m), t.autoplay.running && d(), i().removeEventListener("visibilitychange", u)
        ...
        Object.assign(t, {
            ...
            addSlide: function(e, t) {
                ...
                a.loop && s.loopCreate(), a.observer || s.update(), a.loop ? s.slideTo(o + s.loopedSlides, 0, !1) : s.slideTo(o, 0, !1)
            }.bind(t),
        ...
        s({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: i,
                    slidesSizesGrid: a
                } = t, n = t.params.coverflowEffect, r = t.isHorizontal(), l = t.translate, o = r ? e / 2 - l : s / 2 - l, d = r ? n.rotate : -n.rotate, p = n.depth;
                for (let e = 0, t = i.length; e < t; e += 1) {
                    ...
                    .001 > Math.abs(v) && (v = 0), .001 > Math.abs(g) && (g = 0), .001 > Math.abs(f) && (f = 0), .001 > Math.abs(u) && (u = 0), .001 > Math.abs(h) && (h = 0), .001 > Math.abs(w) && (w = 0);
                    const b = `translate3d(${v}px,${g}px,${f}px)  rotateX(${h}deg) rotateY(${u}deg) scale(${w})`;
                    if (H(n, t).transform(b), t[0].style.zIndex = 1 - Math.abs(Math.round(c)), n.slideShadows) {
                        ...
                        0 === e.length && (e = F(n, t, r ? "left" : "top")), 0 === s.length && (s = F(n, t, r ? "right" : "bottom")), e.length && (e[0].style.opacity = 0 < c ? c : 0), s.length && (s[0].style.opacity = 0 < -c ? -c : 0)
                    }
                }
            },
            setTransition: e => {
        ...
        G({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    0 > d ? (m = n.next, f = !0) : 0 < d && (m = n.prev, f = !0), u.forEach((e, t) => {
                    ...
                    if (f && m.shadow || !f) {
                        ...
                        if (0 === e.length && m.shadow && (e = F(n, i)), e.length) {
...
var fusionLightboxVideoVars = {
    "lightbox_video_width": "900",
    "lightbox_video_height": "1220"
};
    ...
    e.infinitescroll = function(i, t, o) {
        ...
        _create: function(t, o) {
            ...
            return n.loading.start = n.loading.start || function() {
                ...
                n.behavior && t["_callback_" + n.behavior] !== i && t["_callback_" + n.behavior].call(e(n.contentSelector)[0], s, r), o && o.call(e(n.contentSelector)[0], s, n, r), n.prefill && a.on("resize.infinite-scroll", t._prefill)
...
function resizeVideo(e) {
    var t, i, o, a, d, n, r, s, u, f, v, c, m, l, p, y = e.parent();
...
jQuery(document).ready(function(e) {
    ...
    void 0 !== t && (Number(fusionVideoBgVars.status_yt) && "undefined" != typeof onYouTubeIframeAPIReady && onYouTubeIframeAPIReady(), jQuery("[data-youtube-video-id], [data-vimeo-video-id]").parent().css("overflow", "hidden")), i.each(function() {
        var e = jQuery(this);
        setTimeout(function() {
            resizeVideo(e)
        }, 500)
    ...
    var i = function(t, e, i) {
        ...
        var r = e.documentElement,
            ...
            z = function(t, e, i) {
                ...
                i && z(t, e), f.forEach(function(i) {
                    t[a](i, e)
                })
            },
            b = function(t, i, n, r, s) {
                var o = e.createEvent("Event");
                return n || (n = {}), n.instance = a, o.initEvent(i, !r, !s), o.detail = n, t.dispatchEvent(o), o
            },
            p = function(e, i) {
                var a;
            ...
            E = (R = [], j = [], k = R, T = function() {
                var t = k;
                for (k = R.length ? j : R, B = !0, P = !1; t.length;) t.shift()();
                B = !1
            }, q = function(t, i) {
                B && !i ? t.apply(this, arguments) : (k.push(t), P || (P = !0, (e.hidden ? l : d)(T)))
            }, q._lsFlush = T, q),
            w = function(t, e) {
                return e ? function() {
                    E(t)
            ...
            L = function() {
                var s, f, g, C, L, N, S, x, F, W, B, P, R, j, k, T, q, I, $, D = /^img$/i,
                    H = /^iframe$/i,
                    ...
                    G = function(t) {
                        return null == P && (P = "hidden" == A(e.body, "visibility")), P || !("hidden" == A(t.parentNode, "visibility") && "hidden" == A(t, "visibility"))
                    },
                    K = function(t, i) {
                        var a, n = t,
                            s = G(t);
                        for (x -= i, B += i, F -= i, W += i; s && (n = n.offsetParent) && n != e.body && n != r;)(s = (A(n, "opacity") || 1) > 0) && "visible" != A(n, "overflow") && (a = n.getBoundingClientRect(), s = W > a.left && F < a.right && B > a.top - 1 && x < a.bottom + 1);
                        return s
                    },
                    X = function() {
                        var t, i, o, l, d, u, c, g, m, y, v, h, z = a.elements;
                        if ((C = n.loadMode) && V < 8 && (t = z.length)) {
                            for (i = 0, J++; i < t; i++)
                                if (z[i] && !z[i]._lazyRace)
                                    if (!Q || a.prematureUnveil && a.prematureUnveil(z[i])) nt(z[i]);
                                    else if ((g = z[i].getAttribute("data-expand")) && (u = 1 * g) || (u = O), y || (y = !n.expand || n.expand < 1 ? r.clientHeight > 500 && r.clientWidth > 500 ? 500 : 370 : n.expand, a._defEx = y, v = y * n.expFactor, h = n.hFac, P = null, O < v && V < 1 && J > 2 && C > 2 && !e.hidden ? (O = v, J = 0) : O = C > 1 && J > 1 && V < 6 ? y : 0), m !== u && (N = innerWidth + u * h, S = innerHeight + u, c = -1 * u, m = u), o = z[i].getBoundingClientRect(), (B = o.bottom) >= c && (x = o.top) <= S && (W = o.right) >= c * h && (F = o.left) <= N && (B || W || F || x) && (n.loadHidden || G(z[i])) && (f && V < 3 && !g && (C < 3 || J < 4) || K(z[i], u))) {
                                if (nt(z[i]), d = !0, V > 9) break
                            } else !d && f && !l && V < 4 && J < 4 && C > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || !g && (B || W || F || x || "auto" != z[i].getAttribute(n.sizesAttr))) && (l = s[0] || z[i]);
                            l && !d && nt(l)
                        }
                    },
                    Y = (R = X, k = 0, T = n.throttleDelay, q = n.ricTimeout, I = function() {
                        j = !1, k = i.now(), R()
                    }, $ = u && q > 49 ? function() {
                        u(I, {
                            timeout: q
                        ...
                        var e;
                        (t = !0 === t) && (q = 33), j || (j = !0, (e = T - (i.now() - k)) < 0 && (e = 0), t || e < 9 ? $() : l($, e))
                    }),
                    Z = function(t) {
                        var e = t.target;
                        e._lazyCache ? delete e._lazyCache : (U(t), v(e, n.loadedClass), h(e, n.loadingClass), z(e, et), b(e, "lazyloaded"))
                    },
                    tt = w(Z),
                    et = function(t) {
                        tt({
                    ...
                    at = w(function(t, e, i, a, r) {
                        var s, o, d, u, f, y;
                        (f = b(t, "lazybeforeunveil", e)).defaultPrevented || (a && (i ? v(t, n.autosizesClass) : t.setAttribute("sizes", a)), o = t.getAttribute(n.srcsetAttr), s = t.getAttribute(n.srcAttr), r && (d = t.parentNode, u = d && c.test(d.nodeName || "")), y = e.firesLoad || "src" in t && (o || s || u), f = {
                            target: t
                        }, v(t, n.loadingClass), y && (clearTimeout(g), g = l(U, 2500), z(t, et, !0)), u && m.call(d.getElementsByTagName("source"), it), o ? t.setAttribute("srcset", o) : s && !u && (H.test(t.nodeName) ? function(t, e) {
                            ...
                            src: s
                        })), t._lazyRace && delete t._lazyRace, h(t, n.lazyClass), E(function() {
                    ...
                    nt = function(t) {
                        if (!t._lazyRace) {
                            var e, i = D.test(t.nodeName),
                                ...
                                r = "auto" == a;
                            (!r && f || !i || !t.getAttribute("src") && !t.srcset || t.complete || y(t, n.errorClass) || !y(t, n.lazyClass)) && (e = b(t, "lazyunveilread").detail, r && M.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, V++, at(t, e, r, a, i))
                        }
                    },
                    rt = _(function() {
                        n.loadMode = 3, Y()
                    ...
                    ot = function() {
                        f || (i.now() - L < 999 ? l(ot, 999) : (f = !0, n.loadMode = 3, Y(), o("scroll", st, !0)))
                    };
                return {
                    _: function() {
                        L = i.now(), a.elements = e.getElementsByClassName(n.lazyClass), s = e.getElementsByClassName(n.lazyClass + " " + n.preloadClass), o("scroll", Y, !0), o("resize", Y, !0), o("pageshow", function(t) {
                            if (t.persisted) {
                        ...
                        }), /d$|^c/.test(e.readyState) ? ot() : (o("load", ot), e.addEventListener("DOMContentLoaded", Y), l(ot, 2e4)), a.elements.length ? (X(), E._lsFlush()) : Y()
                    },
                    checkElems: Y,
                    unveil: nt,
                    _aLSL: st
            ...
            M = (x = w(function(t, e, i, a) {
                var n, r, s;
                if (t._lazysizesWidth = a, a += "px", t.setAttribute("sizes", a), c.test(e.nodeName || ""))
                    for (n = e.getElementsByTagName("source"), r = 0, s = n.length; r < s; r++) n[r].setAttribute("sizes", a);
                i.detail.dataAttr || p(t, i.detail)
            }), F = function(t, e, i) {
                var a, n = t.parentNode;
                n && (i = C(t, n, i), (a = b(t, "lazybeforesizes", {
                    width: i,
                    dataAttr: !!e
                })).defaultPrevented || (i = a.detail.width) && i !== t._lazysizesWidth && x(t, n, a, i))
            }, W = _(function() {
                var t, e = S.length;
                if (e)
                    for (t = 0; t < e; t++) F(S[t])
                ...
                _: function() {
                    S = e.getElementsByClassName(n.autosizesClass), o("resize", W)
                },
                checkElems: W,
                updateElem: F
            }),
        ...
        var a = /\s+(\d+)(w|h)\s+(\d+)(w|h)/,
            ...
            l = {
                getParent: function(e, i) {
                    var a = e,
                        n = e.parentNode;
                    return i && "prev" != i || !n || !s.test(n.nodeName || "") || (n = n.parentNode), "self" != i && (a = "prev" == i ? e.previousElementSibling : i && (n.closest || t.jQuery) && (n.closest ? n.closest(i) : jQuery(n).closest(i)[0]) || n), a
                },
                getFit: function(t) {
                    ...
                    return !o.fit && s && (e = s.match(n)) && (o.fit = e[1]), o.fit ? (!(i = t._lazysizesParentContainer || t.getAttribute("data-parent-container")) && s && (e = s.match(r)) && (i = e[1]), o.parent = l.getParent(t, i)) : o.fit = a.objectFit, o
                },
                getImageRatio: function(e) {
                    var i, n, r, l, d, u, c, f = e.parentNode,
                        g = f && s.test(f.nodeName || "") ? f.querySelectorAll("source, img") : [e];
                    for (i = 0; i < g.length; i++)
                        if (n = (e = g[i]).getAttribute(o.srcsetAttr) || e.getAttribute("srcset") || e.getAttribute("data-pfsrcset") || e.getAttribute("data-risrcset") || "", r = e._lsMedia || e.getAttribute("media"), r = o.customMedia[e.getAttribute("data-media") || r] || r, n && (!r || (t.matchMedia && matchMedia(r) || {}).matches)) {
                            (l = parseFloat(e.getAttribute("data-aspectratio"))) || ((d = n.match(a)) ? "w" == d[2] ? (u = d[1], c = d[3]) : (u = d[3], c = d[1]) : (u = e.getAttribute("width"), c = e.getAttribute("height")), l = u / c);
                            break
                        }
                    return l
                },
                calculateSize: function(t, e) {
                    var i, a, n, r = this.getFit(t),
                        s = r.fit,
                        o = r.parent;
                    return "width" == s || ("contain" == s || "cover" == s) && (a = this.getImageRatio(t)) ? (o ? e = o.clientWidth : o = t, n = e, "width" == s ? n = e : (i = e / o.clientHeight) && ("cover" == s && i < a || "contain" == s && i > a) && (n = e * (a / i)), n) : e
                }
            };
...
const lazyBg = function(t) {
    var e = t.getAttribute("data-bg"),
        i = t.getAttribute("data-bg-medium") || e,
        a = t.getAttribute("data-bg-small") || i,
        n = t.getAttribute("data-bg-gradient");
    Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_medium + "px)") && (e = i), Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_small + "px)") && (e = a), n && e ? t.style.backgroundImage = n + ",url(" + e + ")" : e && (t.style.backgroundImage = "url(" + e + ")")
};
...
var avadaLiveSearchVars = {
    "live_search": "1",
    "ajaxurl": "https:\/\/lincolncapitalcorp.com\/wp-admin\/admin-ajax.php",
...
! function(e) {
    ...
    window.awb_oc_timeouts = {}, window.awbOffCanvas = {
        ...
        open_off_canvas: function(a, n = !0, t = !1) {
            ...
            if (("off" === i.status_css_animations || "desktop" === i.status_css_animations && window.cssua.ua.mobile) && (f = !1), f) {
        ...
        close_off_canvas: function(a, n = !0) {
            ...
            if (("off" === s.status_css_animations || "desktop" === s.status_css_animations && window.cssua.ua.mobile) && (i = !1), i) {
...
! function(e) {
    ...
    function a(a) {
        const o = a.dataset.type || "container",
            n = a.dataset.animation || "fade",
            s = "fade" === n ? "fade" : "creative";
        let i = "creative" === s ? t[n] : "";
        const c = "no" === a.dataset.loop,
            l = Number(a.dataset.slideshowSpeed) || 5e3,
            r = Number(a.dataset.animationSpeed) || 800,
            d = a.dataset.direction || "up",
            p = a.dataset.pause_on_hover || !1;
        let u = ".fusion-flex-container";
        "column" === o && (u = ".fusion-layout-column");
        const y = e(a).closest(u);
        "slide" === n && "up" !== d && (i = t["slide_" + d]);
        const f = y.data("cid");
        if (f) window[`background_slider_${f}`] && window[`background_slider_${f}`].destroy(!0, !0), window[`background_slider_${f}`] = new Swiper(a, {
            effect: s,
            loop: !c,
            speed: r,
            creativeEffect: i,
        ...
        }), p && (y.on("mouseover", function() {
            window[`background_slider_${f}`].autoplay.pause()
        }), y.on("mouseleave", function() {
            window[`background_slider_${f}`].autoplay.run()
        }));
        else {
            const e = new Swiper(a, {
                effect: s,
                loop: !c,
                speed: r,
                creativeEffect: i,
    ...
    e(".awb-background-slider").each(function(e, t) {
        a(t)
    }), e(window).on("load fusion-reinit-background-slider", function(e, t) {
        const o = document.querySelector(`[data-cid="${t}"] .awb-background-slider`);
        o && a(o)
    })
}(jQuery);
...
avadaFusionSlider.prototype.fusionReanimateSlider = function(e) {
    ...
    return this.isShortcode && this.isFullHeight ? this.fullHeightOffset ? fusion.getHeight(this.fullHeightOffset) : 0 : jQuery(".fusion-tb-header:not( #side-header )").length ? jQuery(".fusion-tb-header").height() : this.breakpointReached() && jQuery("#side-header").length ? jQuery("#side-header").outerHeight() : jQuery(".fusion-header-wrapper").height()
    ...
    (void 0 !== t ? t : this.$el.find("video")).each(function() {
        var t, a, r, n;
        jQuery(this).removeAttr("style"), (r = jQuery(this).width() / jQuery(this).height() * e) < i && !s.$el.hasClass("full-width-slider") && (r = i), t = "-" + (r - s.$el.width()) / 2 + "px", a = s.$el.parent().parent().parent().width(), 1 <= s.$el.parents(".post-content").length && (a = s.$el.width()), a > r && !0 === s.percentageWidth && !s.isFullScreen ? (r = "100%", t = 0) : s.isFullScreen && (a > r ? (r = "100%", t = 0, n = "static") : n = "absolute"), jQuery(this).width(r), jQuery(this).css("left", t), n && jQuery(this).css("position", n)
    })
    ...
    var e;
    "left" !== avadaFusionSliderVars.header_position && "right" !== avadaFusionSliderVars.header_position || this.$el.hasClass("fixed-width-slider") || !this.isParallax || (this.$el.css("max-width", jQuery("#wrapper").width() + 1), jQuery("body").hasClass("side-header-left") ? this.$el.css({
        left: "50%",
        transform: "translateX(calc(" + jQuery("#side-header").width() + "px / 2 - 50%))"
    }) : jQuery("body").hasClass("side-header-right") && this.$el.css({
        left: "50%",
        transform: "translateX(calc(" + jQuery("#side-header").width() + "px / -2 - 50%))"
    })), this.isParallax && this.isBoxedMode && "top" === avadaFusionSliderVars.header_position && (this.$el.css("width", jQuery(".layout-boxed-mode #wrapper").width()), e = "-" + this.$el.width() / 2 + "px", this.$el.css("left", "50%"), this.$el.css("margin-left", e))
    ...
    var e = this,
        i = {
            ...
            start: function(i) {
                ...
                }), jQuery(e.$el).closest("#sliders-container").length && jQuery(document.body).trigger("sticky_kit:recalc")
            },
            before: function() {
    ...
    var t, s, a, r, n = this;
    s = (t = n.$el.find(".flex-active-slide")).find(".tfs-scroll-down-indicator"), a = n.isFullScreen ? 0 : n.getWidth(), r = n.isFullScreen ? n.getHeightOnFS() : n.getHeight(a), void 0 !== s.offset() && t.find(".slide-content").offset().top + t.find(".slide-content").height() + 25 < s.offset().top ? s.css("opacity", "1") : s.css("opacity", "0"), n.isFullScreen && jQuery(".fusion-top-frame").length && (r = r - jQuery(".fusion-top-frame").height() - jQuery(".fusion-bottom-frame").height()), r < n.getMaxHeight() && (r = n.getMaxHeight()), setTimeout(function() {
        n.updateVideoContainers(r, a)
    }, 100), n.updateXPosition(), n.updateHeight(r), n.maybeUpdateButtons(), n.isParallax && n.parallaxAdjustments(), Modernizr.mq("only screen and (max-width: 640px)") ? (n.$el.parents(".fusion-slider-container").css("height", r), n.$el.css("height", r), n.$el.find(".background, .mobile_video_image").css("height", r)) : (n.breakpointReached(), n.$el.parents(".fusion-slider-container").css("height", r), n.$el.css("height", r), n.$el.find(".background, .mobile_video_image").css("height", r))
...
function wrapGravitySelects(e) {
    var r = ".gform_wrapper select:not([multiple])",
        t = jQuery(r);
    "string" == typeof e && void 0 !== e && (t = -1 !== e.indexOf("#gform_wrapper") ? jQuery(e + r) : jQuery(e).find(r)), t.filter(":visible").each(function() {
        var e = jQuery(this);
        setTimeout(function() {
...
}), recursiveGFormSubmissionHandler(), jQuery(document).on("gform_post_render", function(e, r) {
    wrapGravitySelects("#gform_wrapper_" + r)
}), jQuery(window).on("load", function() {
...
jQuery(document).ready(function() {
    ...
    function t() {
        var e, n, i, s = jQuery(".fusion-header-has-flyout-menu"),
            u = 0,
        ...
        }), 1 <= jQuery(".fusion-mobile-menu-design-flyout").length ? (n = 1 <= jQuery(".fusion-is-sticky").length && 1 <= jQuery(".fusion-mobile-sticky-nav-holder").length ? s.find(".fusion-flyout-menu.fusion-mobile-sticky-nav-holder") : s.find(".fusion-flyout-menu:not(.fusion-mobile-sticky-nav-holder)"), s.find(".fusion-flyout-menu").css({
            display: "none"
        }), n.css({
            display: "flex"
        })) : n = s.find(".fusion-flyout-menu"), jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").length && (u += jQuery(".fusion-header-has-flyout-menu .fusion-secondary-header").outerHeight()), jQuery("body").hasClass("layout-boxed-mode") && (u += jQuery("body").outerHeight(!0) - jQuery("body").outerHeight()), window.$wpadminbarHeight = fusion.getAdminbarHeight(), e = jQuery(".fusion-header-has-flyout-menu-content").height() + jQuery(".fusion-secondary-header").height() + window.$wpadminbarHeight, s.hasClass("fusion-flyout-menu-active") && (n.css({
            height: "calc(100% - " + e + "px)",
            "margin-top": e
        }), n.find(".fusion-menu").height() > n.height() && n.css("display", "flex")), s.find(".fusion-header").length && (i = s.find(".fusion-header").offset().top, !avadaMenuVars.header_sticky || t && !avadaMenuVars.header_sticky_tablet || o && !avadaMenuVars.header_sticky_mobile ? (s.find(".fusion-header").css({
            position: "fixed",
            width: "100%",
            "max-width": "100%",
            top: window.$wpadminbarHeight + u,
            "z-index": "210"
        }), jQuery(".fusion-header-sticky-height").css({
            display: "block",
            height: s.find(".fusion-header").outerHeight()
        })) : i > window.$wpadminbarHeight && (s.find(".fusion-header").css({
            position: "fixed",
            top: window.$wpadminbarHeight + u
        }), jQuery(".layout-boxed-mode").length && s.find(".fusion-header").css("max-width", jQuery("#wrapper").outerWidth() + "px"), jQuery(".fusion-header-wrapper").css("height", "")))
    }
...
var avadaHeaderVars = {
    ...
    "nav_highlight_style": "background",
    "logo_margin_top": "5px",
...
function awbScrollToTarget(e, t) {
    var n, o, s, i, a, r, l, u, c, h, f, d, p = jQuery("html").hasClass("ua-edge") || jQuery("html").hasClass("ua-safari-12") || jQuery("html").hasClass("ua-safari-11") || jQuery("html").hasClass("ua-safari-10") ? "body" : "html",
        g = jQuery(".fusion-tb-header").length,
        y = !1,
        m = !1;
    if (t = void 0 !== t ? t : 0, e.length) {
        if (e.parents(".fusion-scroll-section").hasClass("awb-swiper-full-sections")) return;
        if ((e.parents(".hundred-percent-height-scrolling").length || e.find(".hundred-percent-height-scrolling").length) && (0 != fusionScrollToAnchorVars.container_hundred_percent_height_mobile || !Modernizr.mq("only screen and (max-width: " + fusionScrollToAnchorVars.content_break_point + "px)"))) {
            if ((d = e.hasClass("fusion-scroll-section-element") ? e : e.parents(".fusion-scroll-section-element")).hasClass("active") && d.offset().top >= jQuery(window).scrollTop() && d.offset().top < jQuery(window).scrollTop() + jQuery(window).height()) return !1;
            if (location.hash && "#_" === location.hash.substring(0, 2) && jQuery(".fusion-page-load-link").addClass("fusion-page.load-scroll-section-link"), e.parents(".fusion-scroll-section").length) return e.parents(".fusion-scroll-section").hasClass("active") ? e.parents(".fusion-scroll-section").find(".fusion-scroll-section-nav").find(".fusion-scroll-section-link[data-element=" + d.data("element") + "]").trigger("click") : (f = Math.ceil(e.parents(".fusion-scroll-section").offset().top), jQuery(p).animate({
                scrollTop: f
            }, {
                duration: 400,
                easing: "easeInExpo",
                complete: function() {
                    setTimeout(function() {
                        e.parents(".fusion-scroll-section").find(".fusion-scroll-section-nav").find(".fusion-scroll-section-link[data-element=" + d.data("element") + "]").trigger("click"), location.hash && "#_" === location.hash.substring(0, 2) && ("history" in window && "replaceState" in history && history.replaceState("", window.location.href.replace("#_", "#"), window.location.href.replace("#_", "#")), jQuery(".fusion-page-load-link").removeClass("fusion-page.load-scroll-section-link"))
                    }, parseInt(fusionScrollToAnchorVars.hundred_percent_scroll_sensitivity) + 50)
                }
            })), !1
        }
        return e.parents(".awb-off-canvas").length ? 0 !== e.parents(".awb-off-canvas-wrap.awb-show").length && (l = (r = e.parents(".awb-off-canvas-wrap.awb-show").find(".off-canvas-content"))[0].getBoundingClientRect().top, u = e[0].getBoundingClientRect().top, c = r.scrollTop(), i = u < l ? c - (l - u) : Math.abs(c + (u - l)), h = r[0].scrollHeight - r.outerHeight(), i > h && (i = h), void r.animate({
            scrollTop: i
        }, {
            duration: 400
        })) : (n = fusion.getAdminbarHeight(), s = jQuery(document).scrollTop(), g ? (jQuery("body").addClass("fusion-scrolling-active"), (y = fusionGetStickyOffset()) || (y = n), i = e.offset().top - y - t) : (o = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, i = e.offset().top - n - o - t), a = Math.abs(s - i) / 2, f = s > i ? s - a : s + a, jQuery(p).animate({
            scrollTop: f
        }, {
            duration: 400,
            easing: "easeInExpo",
            complete: function() {
                n = fusion.getAdminbarHeight(), g ? ((y = fusionGetStickyOffset()) || (y = n), i = Math.ceil(e.offset().top) - y - t) : (o = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, i = Math.ceil(e.offset().top) - n - o - t), jQuery(p).animate({
                    scrollTop: i
                }, 450, "easeOutExpo", function() {
                    location.hash && "#_" === location.hash.substring(0, 2) && "history" in window && "replaceState" in history && history.replaceState("", window.location.href.replace("#_", "#"), window.location.href.replace("#_", "#")), g && ((m = fusionGetStickyOffset()) || (m = n), y !== m && (i = Math.ceil(e.offset().top) - m - t, jQuery(p).animate({
                        scrollTop: i
                    }, 450)), jQuery("body").removeClass("fusion-scrolling-active"))
                })
            }
    ...
    jQuery("body").on("click", '.fusion-menu a:not([href="#"], .fusion-megamenu-widgets-container a, .search-link), .fusion-widget-menu a, .fusion-secondary-menu a, .fusion-mobile-nav-item a:not([href="#"], .search-link), .fusion-button:not([href="#"], input, button), .fusion-one-page-text-link:not([href="#"]), .fusion-content-boxes .fusion-read-more:not([href="#"]), .fusion-imageframe > .fusion-no-lightbox, .content-box-wrapper:not(.link-area-box) .heading-link, a.woocommerce-review-link, .awb-toc-el .awb-toc-el__item-anchor', function(e) {
        ...
        if (this.hash) {
            if (r = jQuery(this).attr("target") ? jQuery(this).attr("target") : "_self", s = (o = void 0 !== (n = (t = jQuery(this).attr("href")).split("#"))[1] ? n[1] : "").substring(0, 1), a = (i = n[0]).substring(i.length - 1, i.length), window.location.host !== this.host) return;
            if ("#hubspot-open-chat" === t) return;
            if ("#previousStep" === t || "#nextStep" === t) return;
            if (void 0 !== (l = o.split("-"))[0] && "tab" === l[0] && jQuery(this).parents(".awb-menu__mega-wrap").length) return;
            if ("/" !== a && (i += "/"), "!" === s || "/" === s) return;
...
jQuery(document).ready(function() {
    jQuery(".fusion-video").each(function() {
        !jQuery(this).parents(".fusion-modal").length && 1 == jQuery(this).data("autoplay") && jQuery(this).is(":visible") && jQuery(this).find("iframe").each(function() {
            var e, i = jQuery(this),
                o = !1;
            i.attr("data-orig-src") && (o = !0), o ? (e = i.attr("data-orig-src").replace("autoplay=0", "autoplay=1"), i[0].contentWindow.location.replace(e)) : i.attr("src", i.attr("src").replace("autoplay=0", "autoplay=1"))
        })
    }), jQuery(window).on("resize", function() {
